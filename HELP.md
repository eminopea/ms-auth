...
* The original package name 'com.template.ms-auth' is invalid and this project uses 'com.template.ms_auth' instead.
...
* [Spring Data Redis (Access+Driver)](https://docs.spring.io/spring-boot/3.5.15-SNAPSHOT/reference/data/nosql.html#data.nosql.redis)
